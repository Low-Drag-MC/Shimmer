...
public class CopyDepthTarget extends RenderTarget {
    ...
    public static void hookDepthBuffer(RenderTarget fbo, int depthBuffer) {
        ...
        if(!fbo.isStencilEnabled())
            ...
            GlStateManager._glFramebufferTexture2D(org.lwjgl.opengl.GL30.GL_FRAMEBUFFER, org.lwjgl.opengl.GL30.GL_DEPTH_STENCIL_ATTACHMENT, 3553, depthBuffer, 0);
        } else {
            GlStateManager._glFramebufferTexture2D(org.lwjgl.opengl.GL30.GL_FRAMEBUFFER, org.lwjgl.opengl.GL30.GL_DEPTH_ATTACHMENT, 3553, depthBuffer, 0);
            GlStateManager._glFramebufferTexture2D(org.lwjgl.opengl.GL30.GL_FRAMEBUFFER, org.lwjgl.opengl.GL30.GL_STENCIL_ATTACHMENT, 3553, depthBuffer, 0);
        }
    }
