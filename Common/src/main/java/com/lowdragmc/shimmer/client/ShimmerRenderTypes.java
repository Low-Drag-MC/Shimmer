...
public class ShimmerRenderTypes {
    ...
    public static class AuroraRenderType extends RenderType{

        public static final VertexFormat AuroraVertexFormat = new VertexFormat(ImmutableMap.<String, VertexFormatElement>builder()
                .put("Position", ELEMENT_POSITION)
                .put("UV",ELEMENT_UV)
                .build());

        public AuroraRenderType(String $$0, VertexFormat $$1, VertexFormat.Mode $$2, int $$3, boolean $$4, boolean $$5, Runnable $$6, Runnable $$7) {
