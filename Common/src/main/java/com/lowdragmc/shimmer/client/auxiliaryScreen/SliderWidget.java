...
public class SliderWidget extends AbstractSliderButton {
	...
	protected void updateMessage() {
		if (formatStr.contains("%d")) {
			this.setMessage(prefixMessage.copy().append(new TextComponent(":" + String.format(formatStr, (int) actualValue))));
		} else {
			this.setMessage(prefixMessage.copy().append(new TextComponent(":" + String.format(formatStr, actualValue))));
		}
	}
