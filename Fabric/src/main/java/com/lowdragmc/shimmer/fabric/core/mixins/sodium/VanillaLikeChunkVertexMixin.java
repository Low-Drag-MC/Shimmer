...
/**
 * The vertex format Embeddium falls back to when a mod asks for the vanilla-like layout; without this the
 * bloom flag would be dropped for anyone running that format.
 */
